...
for tid, fls_label, cb_label, bfn in [
    ...
    set_topic(tid,
        R("FLS", fls_label, "pass1"),
        R("CB", cb_label, "pass2"),
        R("BFN-Bio", bfn, "backup"),
    )
set_topic("ls-ecology",
    R("OSB", "Ch 19–20 — Ecology · ecosystems", "primary"),
    R("FLS", fls("7"), "pass1"),
    R("CB", cb("36", "37"), "pass2"),
...
set_topic("ch-atomic-structure",
    R("Mod", "Ch 3 — Atoms: The Building Blocks of Matter", "pass1"),
