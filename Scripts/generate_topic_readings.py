...
MATH = {
    "math-pemdas": [R("OSA", "§1.1 — Real numbers · order of operations", "primary"), R("Lar", "Ch 2 — Estimation · PEMDAS", "alsoOK"), R("BFN-A", "U1 · Ch 2 Order of Operations · p1", "backup")],
    "math-fractions": [R("OSA", "§1.1 — Fractions · decimals · percent", "primary"), R("Lar", "Ch 2 — Percent · decimals", "alsoOK"), R("BFN-A", "U3 · Ch 15 Percent · p75", "backup")],
    "math-ratios": [R("OSA", "§5.8 — Ratios · proportions", "primary"), R("Lar", "Ch 2–3 — Ratios · proportions", "alsoOK"), R("BFN-A", "U3 · Ch 11 Ratio · p75", "backup")],
    "math-exponents": [R("OSA", "§1.2 · §6.1 — Exponents · scientific notation", "primary"), R("Lar", "Ch 8 §8.1–8.4", "alsoOK"), R("BFN-A", "U4 · Ch 19 Exponents · p141", "backup")],
    "math-word-problems": [R("OSA", "§2.3 — Models and applications", "primary"), R("Lar", "Ch 1–2 — Unit conversion", "alsoOK"), R("BFN-A", "U5 · Ch 28 Literal Equations · p175", "backup")],
    "math-linear-eq": [R("OSA", "§2.3 · §4.1 — Linear equations", "primary"), R("Lar", "Ch 3 — Solving linear equations", "alsoOK"), R("BFN-A", "U5 · Ch 26 Solving Equations · p175", "backup")],
    "math-functions": [R("OSA", "§4.1 — Linear functions", "primary"), R("Lar", "Ch 4 — Graphing functions", "alsoOK"), R("BFN-A", "U8 · Ch 45 Introduction to Functions · p395", "backup")],
    "math-data-graphs": [R("OSA", "§2.1 · §3.3 — Graphs · slope", "primary"), R("Lar", "Ch 4 — Graph reading", "alsoOK"), R("BFN-A", "U6 · Ch 32 Slope · p247", "backup")],
    "math-coordinate": [R("OSA", "§2.1 — Coordinate systems", "primary"), R("Lar", "Ch 4", "alsoOK"), R("BFN-A", "U6 · Ch 31 Coordinate Plane · p247", "backup")],
    "math-probability": [R("OSA", "§13.7 — Probability", "primary"), R("Lar", "Ch 13 — Probability · logic", "alsoOK"), R("BFN-A", "U7 · Ch 42 Probability · p325", "backup")],
    "math-statistics": [R("OSA", "§13.7 — Statistics intro", "primary"), R("Lar", "Ch 13", "alsoOK"), R("BFN-A", "U7 · Ch 40 Mean · Median · Mode · p325", "backup")],
    ...
    "math-roots": [R("OSA", "§1.3 — Radicals", "primary"), R("Lar", "Ch 11 §11.1 — Square roots", "alsoOK"), R("BFN-A", "U11 · Ch 57 Square Roots · p505", "backup")],
    "math-systems": [R("OSA", "§7.1 — Systems (intro)", "primary"), R("BFN-A", "U5 · Ch 29 Systems of Equations · p175", "backup")],
    "math-algebra-expressions": [R("OSA", "§1.1 — Expressions", "primary"), R("BFN-A", "U4 · Ch 21 Algebraic Expressions · p141", "backup")],
    "math-number-theory": [R("OSA", "§1.1 — Integers · real numbers", "primary"), R("Lar", "Ch 2", "alsoOK"), R("BFN-A", "U2 · Ch 6 Integers · p23", "backup")],
