...
extension SeedData {
    ...
    private static func week5Through8Blocks(forWeek week: Int, templateWeek w: Int) -> [StudyBlock] {
        ...
        case 1:
            return [
                ...
                block(week: week, day: .tuesday, subject: .biology, pass: .pass2,
                      book: "FLS", chapter: "Ch 1", title: "Cell Structure (review)",
                ...
                block(week: week, day: .friday, subject: .biology, pass: .pass2,
                      book: "FLS", chapter: "Ch 2", title: "Cell Energy (review)",
        ...
        case 2:
            return [
                ...
                block(week: week, day: .tuesday, subject: .biology, pass: .pass2,
                      book: "FLS", chapter: "Ch 4", title: "Genetics (review)",
                ...
                block(week: week, day: .friday, subject: .biology, pass: .pass2,
                      book: "FLS", chapter: "Ch 9–10", title: "Body Systems (review)",
        ...
        case 3:
            return [
                ...
                block(week: week, day: .tuesday, subject: .biology, pass: .pass2,
                      book: "CB", chapter: "Ch 36–37", title: "Population Ecology · Communities",
                ...
                block(week: week, day: .friday, subject: .biology, pass: .pass2,
                      book: "CB", chapter: "Ch 16 + Ch 24", title: "Microbes · Immune System (deeper)",
        ...
        default:
            return [
                ...
                block(week: week, day: .tuesday, subject: .biology, pass: .pass2,
                      book: "FLS", chapter: "Ch 5–6", title: "Evolution (review)",
                      pass2Book: "CB", pass2Chapter: "Ch 13–14", pass2Title: "Evolution · Speciation",
                ...
                block(week: week, day: .friday, subject: .biology, pass: .pass2,
                      book: "CB", chapter: "Ch 31 + Ch 20", title: "Plants · Animal Structure",
    ...
    static let weeks9Through10: [StudyBlock] = [
        ...
        block(week: 9, day: .tuesday, subject: .biology, pass: .pass3,
              book: "CB/FLS", chapter: "Ch 4 / Ch 1", title: "Cell review",
        ...
        block(week: 9, day: .friday, subject: .biology, pass: .pass3,
              book: "CB/FLS", chapter: "Ch 6–7 / Ch 2", title: "Energy & organization",
        ...
        block(week: 10, day: .friday, subject: .biology, pass: .pass3,
              book: "CB/FLS", chapter: "Ch 16 · 24 · Ch 4", title: "Genetics · microbes · immunity",
